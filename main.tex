...
Minimising timber loss results in a different pattern: only 5\% of the available area is not logged, 14\% is logged under high-intensity short-cycle logging, and 81\% of the available area is logged under low-intensity (10~m$^3$ha$^{-1}$) long-cycle (65 yr) logging. Low-intensity logging is distributed in almost every region of Amazonia, except in the northeast where high-intensity logging prevails (Figure~\ref{fig:mapsStrateg}a). 
By contrast, maximising carbon and biodiversity retention results in preserving 80\% of available forests, and logging 20\% of available forests under the highest intensity (30~m$^3$ha$^{-1}$) and shortest cutting cycle (15 yr) allowed (Figure~\ref{fig:mapsStrateg}b-c). Logged areas are distributed in the most external areas of Amazonia: in southeastern Amazonia for both carbon and biodiversity, in northern Amazonia for carbon and in the southwestern border of Amazonia for biodiversity.  

Balancing timber, carbon and biodiversity optimisation results in preserving XX\% of available forests, logging XX\% of available forests under high-intensity (30~m$^3$ha$^{-1}$) short-cycle (15 yr) logging and only XX\% under low-intensity (10~m$^3$ha$^{-1}$) long-cycle (65 yr) logging (Figure~\ref{fig:mapsStrateg}d). The spatial 
distribution of logging resemble that of "Carbon" and "Biodiversity" strategies (Figure~\ref{fig:mapsStrateg}b-c) with heavily logged areas being concentrated in most external areas, especially in the southeastern border. 

Allowing only 30-yr cutting cycles results in preserving a smaller share of available forests (XX\%) while XX\% was logged under high-intensity (30 m$^3$ha$^{-1}$) logging and XX\% under low-intensity (10 m$^3$ha$^{-1}$) logging (Figure~\ref{fig:mapsStrateg}e). 

Adding a STY constraint results in preserving XX\% of available forests, logging XX\% of available forests under high-intensity (30~m$^3$ha$^{-1}$) short-cycle (15 yr) logging and  XX\% under low-intensity (10~m$^3$ha$^{-1}$) long-cycle (65 yr) logging (Figure~\ref{fig:mapsStrateg}f). High-intensity logging is mainly distributed in southeastern Amazon and low-intensity logging in the southern and western fringes of the region. 

xxx road building [see depending on balanced costs definition]
...
The "Timber" strategy results in the best final timber stocks (+2.5\% of initial timber stocks, Figure~\ref{fig:scenESProv}a) but the highest carbon emissions (-6.5\% of initial carbon stocks, Figure~\ref{fig:scenESProv}b) and highest biodiversity loss (-10.3\% of initial value, Figure~\ref{fig:scenESProv}c). The "Carbon", "Biodiversity" and "Balanced" strategies result in similar changes in ES provision: approximately -4\%~timber, -3\% carbon, and -4\% biodiversity. 
