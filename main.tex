...
Another point that is absent from our analysis is the benefits of improved logging techniques gather under the name of Reduced-Impact Logging (RIL). A compelling body of evidence shows that RIL practices could provide large improvements in terms of timber recovery, carbon emissions and biodiversity protection \cite{Putz2008c,West2014,Tobler2018,Griscom2019}, and many authors thus argue that they should be essential parts of forest management strategies \cite{Runting2018}. Despite this 30-year interest of academics, only xx\% of selectively logged areas in Amazonia use some degree of RIL techniques today (refxx). We thus decided to base our study on currently dominant logging practices, keeping in mind that ES provision would be improved under a RIL scenario. 
